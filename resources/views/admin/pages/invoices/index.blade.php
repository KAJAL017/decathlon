                ...
                <tr class="hover:bg-gray-50 cursor-pointer" onclick="viewInvoice(${inv.id})">
                    ...
                    <td class="px-4 py-3 text-center" onclick="event.stopPropagation()">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            ${inv.status==='draft'?`<button onclick="markSent(${inv.id})" class="p-1.5 text-green-600 hover:bg-green-50 rounded-lg" title="Mark Sent"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg></button>`:''}
                            ${inv.status==='sent'?`<button onclick="markPaid(${inv.id})" class="p-1.5 text-green-600 hover:bg-green-50 rounded-lg" title="Mark Paid"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></button>`:''}
