...
<aside id="sidebar" class="w-64 bg-gradient-to-b from-gray-900 to-gray-800 flex-shrink-0 transition-transform duration-300 lg:translate-x-0 -translate-x-full fixed left-0 top-0 z-30 h-screen shadow-2xl overflow-y-auto">
    ...
    <nav class="p-4 pb-20">
        ...
        <div class="mb-5">
            ...
            <a href="#" class="sidebar-link flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:text-white hover:bg-gray-700/50 rounded-xl transition-all mb-1 opacity-50 cursor-not-allowed" title="Requires storefront integration">
